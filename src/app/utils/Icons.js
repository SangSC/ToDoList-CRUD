export const allList = <i class="fa-solid fa-list-ul"></i>;
export const done = <i class="fa-solid fa-circle-check"></i>;
export const undone = <i class="fa-solid fa-circle-xmark"></i>;
export const warn = <i class="fa-solid fa-circle-exclamation"></i>;
